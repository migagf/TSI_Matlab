% RUN MULTI CASES
% Runs the time history analysis for the suite of ground motions
...
% true = over bridge | false = at grade
on_bridge = true;
...
for SP_index = 1:3   % Speed
    for GM_index = 1:20   % GM index
        for SF_index = 1:8   % Scale Factor
            for CF_index = 1:2   % Coupling Factor (Run Coupled and Decoupled Analyses)
                for NL_index = 1:2   % Linear/Nonlinear
                    
                    % (1) Create analysis code name
                    ...
                    % (2) Define variables for the analysis
                    ...
                    % Bridge model initialization
                    InitializeBridgeModel
                    
                    % Train initial conditions and prellocation of variables                    
                    ...
                    save(strcat("Results\Runs_OB\", AnalysisCode))
                    % PostProcessingGM
