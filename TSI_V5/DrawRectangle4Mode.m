function [] = DrawRectangle4Mode(center_location,L,H,deg,rgb,face)
...
patch('Vertices',[x_coor; y_coor]','Faces',[1 2 3 4],'Edgecolor',rgb,'Facecolor',facecolor,'Linewidth',1.2,'FaceAlpha',.3);
axis equal;
grid on
end