...
PlasticHingePar.beta     = 17000/17000;

PlasticHingePar.rhoeps   = 0.0;
PlasticHingePar.rhox     = 0*0.25; % 0.11
PlasticHingePar.phi      = 1.6;
PlasticHingePar.deltak   = 0*15.0; % 47.0 Real = 40
PlasticHingePar.deltaf   = 0*0.50;  % 0.5
...
BridgePar.C = a0*BridgePar.Kt + a1*BridgePar.M; % Some Stiffness-Proportional Damping
