...
if showplot
    ...
    plot(SummTable_OB(indices1,:).pgv, SummTable_OB(indices1,:).purot/peakrot, 'ro', 'MarkerSize', markersize, 'MarkerFaceColor', 'r', 'MarkerEdgeColor','w')
    plot(SummTable_OB(indices2,:).pgv, SummTable_OB(indices2,:).purot/peakrot, 'r+', 'MarkerSize', 2*markersize)
...
if showplot
    ...
    fontsize(14, 'points')
    plot(pfit1(0:0.01:1.0), 0:0.01:1.0, 'k-', ...
         pfit2(0:0.01:1.0), 0:0.01:1.0, 'r-', 'LineWidth', 2.0, 'HandleVisibility', 'off');

    plot(SummTable_OB(indices1,:).pbv, SummTable_OB(indices1,:).purot/peakrot, 'ko', 'MarkerSize', markersize, 'MarkerFaceColor', 'none', 'MarkerEdgeColor','k')
    plot(SummTable_OB(indices2,:).pbv, SummTable_OB(indices2,:).purot/peakrot, 'k+', 'MarkerSize', 2.0*markersize)
    plot(SummTable_AG(indices3,:).pgv, SummTable_AG(indices3,:).purot/peakrot, 'rs', 'MarkerSize', 1.5*markersize, 'MarkerFaceColor', 'none', 'MarkerEdgeColor','r')
    plot(SummTable_AG(indices4,:).pgv, SummTable_AG(indices4,:).purot/peakrot, 'r*', 'MarkerSize', 1.5*markersize)
    ...
    plot(SummTable_OB(indices1,:).pba/9.81, SummTable_OB(indices1,:).purot/peakrot, 'ko', 'MarkerSize', markersize, 'MarkerFaceColor', 'none', 'MarkerEdgeColor','k')
    plot(SummTable_OB(indices2,:).pba/9.81, SummTable_OB(indices2,:).purot/peakrot, 'kx', 'MarkerSize', 2*markersize)
    plot(SummTable_AG(indices3,:).pga/9.81, SummTable_AG(indices3,:).purot/peakrot, 'rs', 'MarkerSize', 1.5*markersize, 'MarkerFaceColor', 'none', 'MarkerEdgeColor','r')
    plot(SummTable_AG(indices4,:).pga/9.81, SummTable_AG(indices4,:).purot/peakrot, 'r*', 'MarkerSize', 1.5*markersize)
